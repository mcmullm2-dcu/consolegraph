...
/**
 * Outputs arbitrary functions as a graph to the console.
 * 
...
public class Graph {
    ...
    // Constants to control the output
    ...
    // In-memory array to store the graph output
    ...
    /**
     * Populate the relevant areas of the graph according to the given function.
     * 
     * @param point
     *            The character to draw at each graph position
     * @param func
     *            The function to draw to the graph
     */
